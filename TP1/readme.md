...
- [Repositorio del robot Rhino](#repositorio-del-robot-rhino)
  - [Consideraciones para la gestión del repositorio](#consideraciones-para-la-gestión-del-repositorio)
  - [Contenido](#contenido)
    - [Descripción](#descripción)
    - [Características Generales](#características-generales)
    - [Funcionamiento](#funcionamiento)
    - [Aplicaciones](#aplicaciones)
    - [Controlador Mark IV](#controlador-mark-iv)
      - [Características del Controlador Mark IV](#características-del-controlador-mark-iv)
    - [Control del Rhino XR4](#control-del-rhino-xr4)
      - [Configuración de un Nuevo Punto de Inicio](#configuración-de-un-nuevo-punto-de-inicio)
      - [Configuración para 0 absoluto](#configuración-para-0-absoluto)
  - [Instalación de Ubuntu](#instalación-de-ubuntu)
  - [Instalación de ROS2](#instalación-de-ros2)
  - [Que  es ROS2?](#que--es-ros2)
    - [Conceptos claves](#conceptos-claves)
      - [Nodos](#nodos)
    - [Publicar y Suscribir](#publicar-y-suscribir)
    - [Temas (Topics)](#temas-topics)
    - [Mensajes](#mensajes)
    - [Paquetes (Packages)](#paquetes-packages)
  - [Comunicación serie Rhino con python](#comunicación-serie-rhino-con-python)
  - [Comandos para el control del Rhino XR4](#comandos-para-el-control-del-rhino-xr4)
  - [Modelado con URDF](#modelado-con-urdf)
  - [Principales Componentes de URDF](#principales-componentes-de-urdf)
  - [Porqué utilizar URDF](#porqué-utilizar-urdf)
  - [Configuración del entorno y visualización en rviz](#configuración-del-entorno-y-visualización-en-rviz)
      - [Una vez instalado ROS2:](#una-vez-instalado-ros2)
      - [Visualización en rviz](#visualización-en-rviz)
...
- **Más información sobre el Rhino XR4**         
https://web.archive.org/web/20090327053456/http://www.rhinorobotics.com/xr4_flyer.html
...
- **Más información sobre Controlador Mark IV**   
https://web.archive.org/web/20090327053418/http://www.rhinorobotics.com/markiv.html
...
Luego de conocer movimientos y aprender comandos para poder mover el Brazo robótico, se procedió a la instalación de Ubuntu (ya que no se tenia), para la posterior instalación de ROS2.
...
Para utilizar ROS2 con el robot Rhino XR4, es recomendable instalar Ubuntu (este trabajo se realizo en Ubuntu 24.04), ya que este sistema es compatible con ROS2. A continuación en este [link](https://ubuntu.com/download), se detalla el proceso de instalación de Ubuntu.

## Instalación de ROS2 

Una vez instalado Ubuntu , puedes proceder con la instalación de ROS2, en este [link]( https://docs.ros.org/) se encuentra los pasos de instalacion de cualquier version (este trabajo se realizo en ROS2 Jazzy Jalisco).
...
## Configuración del entorno y visualización en rviz
#### Una vez instalado ROS2:
**Se deben realizar los siguientes pasos para configurar el entorno y preparar el sistema para trabajar con el robot Rhino XR4**:
...
**luego de configurar el entorno y realizar las instalaciones necesarias, se deben seguir los siguientes pasos para visualizar el robot Rhino XR4 en rviz:**
