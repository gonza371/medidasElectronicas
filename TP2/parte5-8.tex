...
Veremos que ahora por más que variemos la escala de amplitud, la señal no se perderá, a diferencia de antes que se perdía en 1V/div.
...
Este fenomeno solo se da cuando ambas frecuencias son iguales, es por ello que tuvimos que ajustar la frecuencia del generador de funciones a 403.38Hz. Si la frecuencia del generador de funciones no se ajusta correctamente, la figura se verá inestable.
...
Veremos que la amplitud de la señal del canal 1 es de 0.1V/div x 5 divisiones x 10 de atenuación = 5V, \textbf{(Vpp1 = 5V)}, y la amplitud de la señal del canal 2 es de 1V/div x 4.5 divisiones x 10 de atenuación = 45V \textbf{Vpp2= 45V}. La frecuencia de ambas señales es de 2KHz, ya que ambas señales están sincronizadas y se ven estables en el osciloscopio.

El grafico de las señales queda de la siguiente forma: 

\begin{figure}[H]
	\centering
    \includegraphics[width=0.4\textwidth]{images/cuadros.png}
    \caption{Grafica de señales en modo alternado}
    \label{fig:parte8a}
\end{figure}
