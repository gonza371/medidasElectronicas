...
Este fenomeno de la elipse solo es estable cuando ambas frecuencias son iguales, es por ello que tuvimos que ajustar la frecuencia del generador de funciones a 403.38Hz para lograr una figura estable. Si la frecuencia del generador de funciones no se ajusta correctamente, la figura se verá inestable.
