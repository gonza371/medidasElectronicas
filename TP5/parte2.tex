...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/señalexp2.jpeg}
    \caption{Señal de medición}
\end{figure}

Para esa imagen usamos el capacitor de 4.7 $\mu$F, y obtuvimos un valor de $eR$ de 392 mV, y con esto obtuvimos la resistencia serie equivalente de 19.6 $\Omega$.\\
